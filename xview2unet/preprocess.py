...
def moveempty(prefn, prelabelsfn):
    ...
    emptyprefn = prefn.replace("images", "emptyimages")
    emptypostfn = postfn.replace("images", "emptyimages")
    emptyprelabelsfn = prelabelsfn.replace("labels", "emptylabels")
    emptypostlabelsfn = postlabelsfn.replace("labels", "emptylabels")
...
if __name__ == "__main__":
    pattern = "efs/inputs/xview2/train/images/*pre*"
    emptyimages = []
    for f in tqdm(getjsons(pattern)):
        fn = f.replace("efs/inputs/xview2/train/images", "efs/inputs/xview2/train/labels").replace(
            "png", "json"
        )
    ...
    with open("efs/inputs/xview2/train/emptyimages.txt", "w") as f:
