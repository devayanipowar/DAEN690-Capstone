...
from dmgmodel.effdamageunet import DamageUNet
...
class XViewDataset(Dataset):
    def __init__(
        self, size=None, aug=True, pattern="efs/inputs/xview2/train/images/*pre_disaster*.png"
    ):
        self.name = "train"
        self.aug = aug
...
# sys.path.append('efs/modules/xview2unet')
...
class XViewSystem(pl.LightningModule):
    ...
    def validation_end(self, outputs):
        self.logger.experiment.log_artifact("efs/modules/xview2unet/workspace/damage")
...
if __name__ == "__main__":
    ...
    neptune_logger = NeptuneLogger(
        api_key="eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vdWkubmVwdHVuZS5haSIsImFwaV91cmwiOiJodHRwczovL3VpLm5lcHR1bmUuYWkiLCJhcGlfa2V5IjoiYTczYTJiNTctM2RiYS00Mzk2LWIyNTMtYzJhOGU2MDVkNmIzIn0=",
        project_name="DAEN-690/damage-detection",
        params={"max_epochs": 210},
        experiment_name='train_damage_unet',
        tags=['damage'],
        upload_source_files=['efs/modules/xview2unet/traindamageunet.py', 'efs/modules/xview2unet/effdamageunet.py', 'efs/modules/xview2unet/preprocess.py']
    )

    trainer = pl.Trainer(
        default_save_path="efs/modules/xview2unet/workspace/damage",
        ...
        resume_from_checkpoint="efs/modules/xview2unet/workspace/damage/train_damage_unet/version_DAM-24/checkpoints/_ckpt_epoch_6.ckpt"
    )
    trainer.fit(model)
