...
from dmgmodel.efflocunet import LocUNet
...
class XViewLocSystem(pl.LightningModule):
    ...
    def validation_end(self, outputs):
        self.logger.experiment.log_artifact("efs/modules/xview2unet/workspace/loc")
...
if __name__ == "__main__":
    ...
    neptune_logger = NeptuneLogger(
        ...
        params={"max_epochs": 90},
        experiment_name='train_loc_unet',
        tags=['localization'],
        upload_source_files=['efs/modules/xview2unet/trainlocunet.py', 'efs/modules/xview2unet/efflocunet.py', 'efs/modules/xview2unet/preprocess.py']
    )

    trainer = pl.Trainer(
        default_save_path="efs/modules/xview2unet/workspace/loc",
...
#         resume_from_checkpoint="efs/modules/xview2unet/workspace/loc/train_loc_unet/version_DAM-22/checkpoints/_ckpt_epoch_14.ckpt"
    )
    trainer.fit(model)
